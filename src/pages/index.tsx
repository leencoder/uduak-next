          ...
          <div className="flex flex-wrap pt-10 justify-center">
            <div className="w-full px-[15px] md:px-0 md:w-[435px] md:max-w-[435px] flex-none">
              ...
              >
                ...
                />
                {/* Next Button */}
                <Button type="button" className="btn-bg mb-2 mt-2 w-full">Next</Button>
                ...
                <Button type="button" className="dark-border w-full">Create an account</Button>
                <p className="text-center my-3">
                  <span className="px-2 text-sm">or</span>
                </p>
                {/* Sign in with Google */}
                <Button type="button" className="light-border flex items-center justify-center mb-4 w-full">
                  <img src="/images/google-icon.png" alt="" className="mr-3" />
                  <span>Sign in with Google</span>
                </Button>
                {/* Sign in with Apple */}
                <Button type="button" className="light-border flex items-center justify-center w-full">
